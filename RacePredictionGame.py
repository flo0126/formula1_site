...
if st.session_state['user'] != 'Invalid':
    ...
    with tabs_guess:
        ...
        #for i in userstouse:
            #users.append(i)
        gps = ["Saudi Arabia", "Australia", "Japan", "China", "Miami", "Imola", "Monaco", "Canada", "Spain", "Austria", "Silverstone", "Hungary", "Spa", "Zandvoort", "Monza", "Baku", "Singapore", "USA", "Mexico", "Brazil", "Las Vegas", "Qatar", "Abu Dhabi"]
